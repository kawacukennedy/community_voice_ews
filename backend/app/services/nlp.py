    ...
    "flood": [
        {
            ...
            "sw": ["mafuriko", "maji", "mvua", "mvua kubwa", "ziwa", "kufurika", "kuzama", "gharika"],
            "severity_hint": {
                "critical": ["drowning", "evacuat", "emergency", "kuzama", "dharura"],
                "high": ["waist", "chest", "house", "nyumba", "majengo"],
    ...
    "drought": [
        {
            ...
            "severity_hint": {
                "critical": ["starvation", "death", "dead", "kufa", "njaa kali"],
                "high": ["livestock", "mifugo", "crop", "mazao"],
                "moderate": ["dry", "kavu"],
            },
        },  # noqa: E501
        {"weight": 3, "severity_boost": 2},
    ...
    "pest": [
        {
            ...
            "sw": ["wadudu", "nzige", "vijasumu", "viwavi", "mbung'o", "kushambuliwa", "nyuki", "sisimizi"],
            "severity_hint": {
                "critical": ["swarm", "kundi", "swarming"],
                "high": ["infestation", "kushambulia", "spread"],
                "moderate": ["seen", "found", "some", "baadhi"],
            },
        },  # noqa: E501
    ...
    "disease": [
        {
            ...
            "severity_hint": {
                "critical": ["deaths", "dying", "kufa", "epidemic", "janga"],
                "high": ["hospital", "hospitali", "many", "wengi"],
                "moderate": ["few", "wachache", "some"],
            },
        },  # noqa: E501
        {"weight": 3, "severity_boost": 2},
    ],
    "fire": [
        {
            ...
            "sw": ["moto", "kuungua", "mwako", "moshi", "waliowaka"],
            "severity_hint": {
                "critical": ["spread", "enaa", "uncontrollable", "homes", "nyumba"],
                "high": ["forest", "msitu", "bush", "vichaka"],
                "moderate": ["small", "ndogo"],
            },
        },  # noqa: E501
        {"weight": 2},
    ],
    "conflict": [
        {
            ...
            "sw": ["vita", "mapigano", "shambulio", "uvunjifu", "watu wakimbia"],
            "severity_hint": {
                "critical": ["weapon", "silaha", "death", "kufa", "shooting", "risasi"],
                "high": ["injured", "kujeruhiwa", "attack", "shambulio"],
                "moderate": ["protest", "maandamano", "dispute", "mabishano"],
            },
        },  # noqa: E501
        {"weight": 2},
    ],
    "health": [
        {
            ...
            "sw": ["afya", "kliniki", "hospitali", "dawa", "chanjo", "matibabu", "lishe", "mimba", "usafi"],
            "severity_hint": {
                "critical": ["emergency", "dharura", "immediate", "mara moja"],
                "high": ["severe", "kali", "serious", "mbaya"],
                "moderate": ["need", "hitaji", "require"],
            },
        },  # noqa: E501
        {"weight": 1},
    ],
...
def classify_message(text: str) -> dict:
    ...
    logger.info(
        ...
        severity,
        confidence,
        keywords_found.get(best_category, []),
    )
